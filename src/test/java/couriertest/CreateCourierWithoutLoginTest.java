...
public class CreateCourierWithoutLoginTest {
    ...
    @DisplayName("Создание курьера без обязательного параметра: логин. Негативный") // имя теста
    @Description("Тест проверяет ручку '/api/v1/courier', передает в теле имя и пароль без логина")
    @Test
    ...
    public Response sendPOSTRequestCourierRegistration() {
        ...
        Response response = createCourier.getCreateCourier(null, password, firstName);
        return response;
    }
